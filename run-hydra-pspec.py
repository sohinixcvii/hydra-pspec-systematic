...
if rank == 0:
    ...
    freqs_for_op = freqs[0] #frequency array for the systematic operator and reshaping to shape (Nfreqs,)
    lsts=uvd.lst_array        #shape (Ntimes,)
    if not uvd.use_future_array_shapes:
        freqs = freqs[0]
    ...
    for i_bl, antpair in enumerate(uvd.get_antpairs()):
        ...
        if args.flags:
            ...
            if flags_path_is_dir:
                ...
                bl_flags_path = flags_path / args.flags_file
        ...
        if args.nsamples:
            ...
            if nsamples_path_is_dir:
                ...
                bl_nsamples_path = nsamples_path / args.nsamples_file
        ...
        if args.noise:
            ...
            if noise_path_is_dir:
                ...
                bl_noise_path = noise_path / args.noise_file
        ...
        if args.sigcov0:
            ...
            if sigcov0_path_is_dir:
                ...
                bl_sigcov0_path = sigcov0_path / args.sigcov0_file
        ...
        if args.noise_cov:
            ...
            if noise_cov_path_is_dir:
                ...
                # )
                bl_noise_cov_path = (
                    noise_cov_path / args.noise_cov_file
                )
        ...
        if args.fgmodes:
            ...
            if fgmodes_path_is_dir:
                if not args.fgmodes_file:
                    ...
                    # )
                    fgmodes_path = (
                        fgmodes_path / f"evecs-{freq_str}.npy"
                    )
                else:
                    # fgmodes_path = fgmodes_path / bl_str / args.fgmodes_file
                    fgmodes_path = fgmodes_path / args.fgmodes_file
