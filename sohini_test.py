...
uvd = UVData()
vis_fg_path='/Users/user/Documents/Codes/hydra_sys_project1/hydra-pspec-systematic-multiplicative/test_data/vis-ptsrc-gsm.uvh5'
...
signal_amps, signal_ps, fg_amps, sys_amps, chisq, ln_post = \
        hp.pspec.gibbs_sample(
            ...
            nproc=1,
            write_Niter=10,
            out_dir='./paper_plots/low_dl_fr_0',   
            sys_modes=sys_modes,
            sys_prior=sys_prior,
